...
public extension String {
    ...
    public func bold(_ boldFont: UIFont? = nil) -> NSAttributedString {
		...
		return NSMutableAttributedString(string: self, attributes: [NSFontAttributeName: NSFont.boldSystemFont(ofSize: NSFont.systemFontSize())])
            ...
            if let bFont = boldFont {
                return NSMutableAttributedString(string: self, attributes: [NSFontAttributeName: bFont])
            }
	...
	public func italic(_ italicFont: UIFont? = nil) ->  NSAttributedString {
        if let iFont = italicFont {
            return NSMutableAttributedString(string: self, attributes: [NSFontAttributeName: iFont])
        }
    ...
    public func colored(with color: UIColor, ranging: NSRange? = nil, font: UIFont? = nil) -> NSAttributedString {
        ...
        if let range = ranging {
            let attributedString = NSAttributedString(string: self)
            return attributedString.colored(with: color, ranging: range, font: font)
        }
		return NSMutableAttributedString(string: self, attributes: [NSForegroundColorAttributeName: color])
	}
	#endif
